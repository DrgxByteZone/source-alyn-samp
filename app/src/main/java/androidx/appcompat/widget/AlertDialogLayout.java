...
public class AlertDialogLayout extends AbstractC0697Xz {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i12 = ((LinearLayout.LayoutParams) c0671Wz).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                ...
                if (absoluteGravity != 1) {
                    if (absoluteGravity != 5) {
                        i7 = ((LinearLayout.LayoutParams) c0671Wz).leftMargin + paddingLeft;
                        if (i(i11)) {
                            paddingTop += intrinsicHeight;
                        }
                        int i13 = paddingTop + ((LinearLayout.LayoutParams) c0671Wz).topMargin;
                        childAt.layout(i7, i13, measuredWidth + i7, i13 + measuredHeight2);
                        paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c0671Wz).bottomMargin + i13;
                    } else {
                        i5 = paddingRight - measuredWidth;
                        i6 = ((LinearLayout.LayoutParams) c0671Wz).rightMargin;
                    }
                } else {
                    i5 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + ((LinearLayout.LayoutParams) c0671Wz).leftMargin;
                    i6 = ((LinearLayout.LayoutParams) c0671Wz).rightMargin;
                }
                i7 = i5 - i6;
                if (i(i11)) {
                }
                int i132 = paddingTop + ((LinearLayout.LayoutParams) c0671Wz).topMargin;
                childAt.layout(i7, i132, measuredWidth + i7, i132 + measuredHeight2);
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c0671Wz).bottomMargin + i132;
            }
        }
    }
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0671Wz).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) c0671Wz).height;
                        ((LinearLayout.LayoutParams) c0671Wz).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i12, 0);
                        ((LinearLayout.LayoutParams) c0671Wz).height = i14;
                    }
                }
                i13++;
