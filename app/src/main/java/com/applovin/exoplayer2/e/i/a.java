...
public final class a implements com.applovin.exoplayer2.e.h {
    public static final com.applovin.exoplayer2.e.l vq = new D60(1);
    private final b Co = new b();
    private final com.applovin.exoplayer2.l.y Cp = new com.applovin.exoplayer2.l.y(2786);
    private boolean Cq;
    ...
    public boolean a(com.applovin.exoplayer2.e.i iVar) throws IOException {
        ...
        while (true) {
            ...
            if (yVar.pp() != 2935) {
                ...
                int c = com.applovin.exoplayer2.b.b.c(yVar.hO());
                if (c == -1) {
                    return false;
                }
                iVar.bI(c - 6);
