...
public final class ac implements InterfaceC0987g {
    ...
    public static final InterfaceC0987g.a<ac> br = new C1588k10(16);
    ...
    public static ac g(Bundle bundle) {
        ...
        Bundle bundle3;
        a aVar = new a();
        a c = aVar.a(bundle.getCharSequence(t(0))).b(bundle.getCharSequence(t(1))).c(bundle.getCharSequence(t(2))).d(bundle.getCharSequence(t(3))).e(bundle.getCharSequence(t(4))).f(bundle.getCharSequence(t(5))).g(bundle.getCharSequence(t(6))).c((Uri) bundle.getParcelable(t(7)));
        byte[] byteArray = bundle.getByteArray(t(10));
        if (bundle.containsKey(t(29))) {
            num = Integer.valueOf(bundle.getInt(t(29)));
        } else {
            num = null;
        }
        c.a(byteArray, num).d((Uri) bundle.getParcelable(t(11))).h(bundle.getCharSequence(t(22))).i(bundle.getCharSequence(t(23))).j(bundle.getCharSequence(t(24))).k(bundle.getCharSequence(t(27))).l(bundle.getCharSequence(t(28))).h(bundle.getBundle(t(1000)));
