...
public final class C1855nH {
    public char a;
    public final float[] b;

    public C1855nH(char c, float[] fArr) {
        this.a = c;
        this.b = fArr;
    }
    ...
    public static void b(C1855nH[] c1855nHArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        C1855nH c1855nH;
        ...
        float f9;
        float f10;
        C1855nH[] c1855nHArr2 = c1855nHArr;
        Path path2 = path;
        float[] fArr2 = new float[6];
        int length = c1855nHArr2.length;
        int i4 = 0;
        int i5 = 0;
        char c2 = 'm';
        while (i5 < length) {
            C1855nH c1855nH3 = c1855nHArr2[i5];
            char c3 = c1855nH3.a;
            float[] fArr3 = c1855nH3.b;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];
            ...
            c2 = c1855nH3.a;
            i5++;
            c1855nHArr2 = c1855nHArr;
            path2 = path;
            i4 = i6;
        }
    }

    public C1855nH(C1855nH c1855nH) {
        this.a = c1855nH.a;
        float[] fArr = c1855nH.b;
        this.b = Ld0.f(fArr, fArr.length);
    }
}
