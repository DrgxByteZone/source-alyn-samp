...
public final class C1853nF {
    ...
    public C1853nF(ViewGroup viewGroup) {
        this.c = viewGroup;
    }
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        if (e instanceof InterfaceC1934oF) {
            ((InterfaceC1934oF) e).j(viewGroup, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (e = e(i5)) != null) {
            if (i == 0 && i2 == 0 && i3 == 0 && i4 == 0) {
                ...
                if (e instanceof InterfaceC2015pF) {
                    ((InterfaceC2015pF) e).f(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (e instanceof InterfaceC1934oF) {
                        ((InterfaceC1934oF) e).g(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof InterfaceC1934oF;
                    if (z) {
                        onStartNestedScroll = ((InterfaceC1934oF) parent).h(view2, view, i, i2);
                    } else {
                        if (i2 == 0) {
                            try {
                    ...
                    if (onStartNestedScroll) {
                        ...
                        if (z) {
                            ((InterfaceC1934oF) parent).i(view2, view, i, i2);
                        } else if (i2 == 0) {
                            try {
    ...
    public final void h(int i) {
        ViewParent e = e(i);
        if (e != null) {
            boolean z = e instanceof InterfaceC1934oF;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((InterfaceC1934oF) e).d(i, viewGroup);
            } else if (i == 0) {
                try {
