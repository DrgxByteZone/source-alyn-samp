...
public abstract class AbstractC1903nv {
    ...
    public static final C0105Be c = new C0105Be();

    /* JADX WARN: Type inference failed for: r4v0, types: [Be, java.lang.Object] */
    static {
        C0105Be[] c0105BeArr;
        for (int i = 0; i < 256; i++) {
            int i2 = a[i];
            ...
            C0105Be c0105Be = c;
            while (true) {
                c0105BeArr = (C0105Be[]) c0105Be.c;
                if (i3 > 8) {
                    i3 -= 8;
                    int i5 = (i2 >>> i3) & JfifUtil.MARKER_FIRST_BYTE;
                    AbstractC0435Nx.g(c0105BeArr);
                    C0105Be c0105Be2 = c0105BeArr[i5];
                    if (c0105Be2 == null) {
                        c0105Be2 = new C0105Be();
                        c0105BeArr[i5] = c0105Be2;
                    }
                    c0105Be = c0105Be2;
                }
            }
            int i6 = 8 - i3;
            int i7 = (i2 << i6) & JfifUtil.MARKER_FIRST_BYTE;
            AbstractC0435Nx.g(c0105BeArr);
            Arrays.fill(c0105BeArr, i7, (1 << i6) + i7, (Object) obj);
        }
    }
}
