...
public final class We0 extends AbstractC2449ue0 implements RandomAccess, InterfaceC0889bf0, Df0 {
    public static final int[] d;
    public static final We0 n;
    public int[] b;
    public int c;
    ...
    static {
        int[] iArr = new int[0];
        d = iArr;
        n = new We0(iArr, 0, false);
    }

    public We0(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(we0.b, 0, this.b, this.c, we0.c);
            this.c = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final We0 d(int i) {
        ...
        if (i >= this.c) {
            ...
            return new We0(copyOf, this.c, true);
        }
