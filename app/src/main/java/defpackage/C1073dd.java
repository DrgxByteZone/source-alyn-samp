...
public final class C1073dd {
    ...
    public C1073dd(TextInputLayout textInputLayout) {
    ...
    public static float h(float f, float f2, float f3, TimeInterpolator timeInterpolator) {
        ...
        return AbstractC2803z2.a(f, f2, f3);
    }
    ...
    public final void b() {
        ...
        C0116Bp c0116Bp = AbstractC2803z2.b;
        this.b0 = 1.0f - h(0.0f, 1.0f, 1.0f - f, c0116Bp);
        textInputLayout.postInvalidateOnAnimation();
        this.c0 = h(1.0f, 0.0f, f, c0116Bp);
        textInputLayout.postInvalidateOnAnimation();
        ...
        float f4 = this.X;
        if (f3 != f4) {
            textPaint.setLetterSpacing(h(f4, f3, f, c0116Bp));
        } else {
            textPaint.setLetterSpacing(f3);
        }
        this.H = AbstractC2803z2.a(0.0f, this.S, f);
        this.I = AbstractC2803z2.a(0.0f, this.T, f);
        this.J = AbstractC2803z2.a(0.0f, this.U, f);
    ...
    public final boolean c(CharSequence charSequence) {
        ...
        if (this.E) {
            ...
            return i9.e(charSequence.length(), charSequence);
        }
        return z;
    }
    ...
    public final StaticLayout e(int i, TextPaint textPaint, CharSequence charSequence, float f, boolean z) {
        ...
        CX cx = new CX(charSequence, textPaint, (int) f);
        cx.l = this.A;
        cx.k = z;
        cx.e = alignment;
        cx.j = false;
    ...
    public final void i(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.t = C0299Iq.l(configuration, typeface);
            }
            Typeface typeface2 = this.x;
            if (typeface2 != null) {
                this.w = C0299Iq.l(configuration, typeface2);
            }
    ...
    public final boolean l(Typeface typeface) {
        C1230fb c1230fb = this.z;
        if (c1230fb != null) {
            c1230fb.j = true;
        }
        if (this.u != typeface) {
            this.u = typeface;
            Typeface l = C0299Iq.l(this.a.getContext().getResources().getConfiguration(), typeface);
            this.t = l;
            if (l == null) {
                l = this.u;
            }
    ...
    */
    ...
    public final void n(Typeface typeface) {
        ...
        if (this.x != typeface) {
            this.x = typeface;
            Typeface l2 = C0299Iq.l(this.a.getContext().getResources().getConfiguration(), typeface);
            this.w = l2;
            if (l2 == null) {
                l2 = this.x;
            }
