...
public final class ActionModeCallbackC0752a00 implements ActionMode.Callback {
    ...
    public ActionModeCallbackC0752a00(ActionMode.Callback callback, TextView textView) {
        this.a = callback;
        this.b = textView;
    }
