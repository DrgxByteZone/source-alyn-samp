...
public final class C0779aI {
    public final TextPaint a;
    public final TextDirectionHeuristic b;
    public final int c;
    public final int d;

    public C0779aI(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
        PrecomputedText.Params.Builder breakStrategy;
        PrecomputedText.Params.Builder hyphenationFrequency;
        PrecomputedText.Params.Builder textDirection;
        if (Build.VERSION.SDK_INT >= 29) {
            breakStrategy = ZH.h(textPaint).setBreakStrategy(i);
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof C0779aI) {
                C0779aI c0779aI = (C0779aI) obj;
                if (this.c == c0779aI.c && this.d == c0779aI.d) {
                    TextPaint textPaint = this.a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = c0779aI.a;
    ...
    public C0779aI(PrecomputedText.Params params) {
        TextPaint textPaint;
