...
public final class C1593k4 {
    ...
    public final C1352h4 k;

    public C1593k4(TextView textView) {
        this.i = textView;
    ...
    public final int c(RectF rectF) {
        ...
        if (length != 0) {
            ...
            while (i3 <= i) {
                ...
                StaticLayout a = AbstractC1271g4.a(charSequence, (Layout.Alignment) e(textView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
    ...
    public final boolean j() {
        return !(this.i instanceof C2724y3);
    }
